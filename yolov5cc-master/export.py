...
Usage:
    $ python path/to/export.py --weights yolov5s+FocalLoss+CIOU.pt --img 640 --batch 1
"""
...
def run(weights='./yolov5s+FocalLoss+CIOU.pt',  # weights path
...
def parse_opt():
    ...
    parser.add_argument('--weights', type=str, default='./yolov5s+FocalLoss+CIOU.pt', help='weights path')
