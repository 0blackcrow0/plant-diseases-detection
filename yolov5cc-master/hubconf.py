...
Usage:
    import torch
    model = torch.hub.load('ultralytics/yolov5', 'yolov5s+FocalLoss+CIOU')
"""
...
def _create(name, pretrained=True, channels=3, classes=80, autoshape=True, verbose=True, device=None):
    ...
    Arguments:
        name (str): name of model, i.e. 'yolov5s+FocalLoss+CIOU'
...
def yolov5s(pretrained=True, channels=3, classes=80, autoshape=True, verbose=True, device=None):
    ...
    return _create('yolov5s+FocalLoss+CIOU', pretrained, channels, classes, autoshape, verbose, device)
...
if __name__ == '__main__':
    model = _create(name='yolov5s+FocalLoss+CIOU', pretrained=True, channels=3, classes=80, autoshape=True, verbose=True)  # pretrained
