...
Usage:
    $ python path/to/train.py --data coco128.yaml --weights yolov5s+FocalLoss+CIOU.pt --img 640
"""
...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default='models/yolov5s-DB+CA1.yaml', help='model.yaml path')
    ...
    parser.add_argument('--project', default='runs/train-apple-tomato-new', help='save to project/name')
